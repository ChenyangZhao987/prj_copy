...
//////////////////////////////////////////////////////////////////////////////////
module SSI_top #(
	parameter					S_CHANNEL	=	2	//通道数量（支持 1：单通道、2：双通道、3：三通道、4:四通道）
)(
    input  	wire       			Pcie_rstn,//PCIe复位
