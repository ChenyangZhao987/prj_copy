...
simulate()
{
  xsim ila_0 -key {Behavioral:sim_1:Functional:ila_0} -tclbatch cmd.tcl -protoinst "protoinst_files/XDMA.protoinst" -log simulate.log
}
...
{
  file="xsim.ini"
  lib_map_path="D:/Xilinx/Vivado/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
