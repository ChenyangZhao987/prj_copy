...
#
# FMC_XDMA.tcl: Tcl script for re-creating project 'FMC_XDMA'
#
# Generated by Vivado on Thu Nov 06 10:16:58 +0800 2025
...
#
# 1. This project restoration tcl script (FMC_XDMA.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/bd/XDMA/XDMA.bd"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/new/CRC_calculator.v"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/new/SSI_interface.v"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/new/cfg_reg_ctrl.v"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/new/time_base_gen.v"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/new/unipath_data_collection.v"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/sources_1/new/SSI_top.v"
#    "C:/Users/Zcy/Desktop/XDMA_SSI/FMC_XDMA.srcs/constrs_1/new/SSI_top.xdc"
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/bd/XDMA/XDMA.bd"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/new/CRC_calculator.v"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/new/SSI_interface.v"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/new/cfg_reg_ctrl.v"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/new/time_base_gen.v"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/new/unipath_data_collection.v"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/sources_1/new/SSI_top.v"]"\
 "[file normalize "$origin_dir/FMC_XDMA.srcs/constrs_1/new/SSI_top.xdc"]"\
  ]
  foreach ifile $files {
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xc7k325tffg900-1
...
set_property -name "part" -value "xc7k325tffg900-1" -objects $obj
...
if { [get_property IS_LOCKED [ get_files -norecurse XDMA.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/FMC_XDMA.gen/sources_1/bd/XDMA/hdl/XDMA_wrapper.v" ]
} else {
...
set file "[file normalize "$origin_dir/FMC_XDMA.srcs/constrs_1/new/SSI_top.xdc"]"
...
set_property -name "target_part" -value "xc7k325tffg900-1" -objects $obj
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k325tffg900-1 -flow {Vivado Synthesis 2022} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FMC_XDMA.srcs/utils_1/imports/synth_1" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k325tffg900-1 -flow {Vivado Implementation 2022} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set_property -name "auto_rqs.directory" -value "$proj_dir/FMC_XDMA.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "incremental_checkpoint.more_options" -value "" -objects $obj
set_property -name "include_in_archive" -value "1" -objects $obj
set_property -name "gen_full_bitstream" -value "1" -objects $obj
set_property -name "auto_incremental_checkpoint.directory" -value "$proj_dir/FMC_XDMA.srcs/utils_1/imports/impl_1" -objects $obj
set_property -name "min_rqa_score" -value "0" -objects $obj
